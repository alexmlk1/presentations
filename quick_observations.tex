...
which means: ``considering $X_s$ or not in the domain of the probability measure, does not change the distribution of the output of $\mathcal{M}_f(s)$''.
Observe that in this setting, $\mathcal{A}(\mathcal{D}\setminus X_s)$ is NOT an unlearning algorithm for every $\mathcal{A}$ !
