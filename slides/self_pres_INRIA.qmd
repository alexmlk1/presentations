...
## Certified Removal{transition="slide-in none-out" transition-speed="default-in fast-out"}
::: {.centered-slide}
...
## Certified Removal{transition="fade"}
:::{.centered-slide}
:::{.frame}
...
<div style="display: flex; align-items: center; justify-content: space-between;">
  ...
  <img src="images/plant_testt.png" style="max-width: 65%;">
  <figcaption style="text-align: center; font-size: 0.6em;">
    Common Cowparsnip
  </figcaption>
  ...
  <figcaption style="text-align: left; font-size: 0.6em; color: red;">
    Poison Hemlock
  </figcaption>
