...
\begin{itemize}
  ...
  {\color{RoyalBlue}
    \item One of the reasons why we are analyzing unlearning is that it's kind of the dual problem of finiding influencial samples.
    However, the authors of \cite{pan_misalignment_2026} state that in general this correlation is not high. 
    ...
    In \cite{bui2026batch}, they propose an iterative algorithm using the influence function approximation step by step. The main issue they managed to solve is the computational cost for such algorithm:
