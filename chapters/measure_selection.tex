...
\begin{definition*}\label{def:3}
    Given two training algorithms $\mathcal{A}$ and $\mathcal{A}'$, we say that they are $(\alpha,\delta)$-indistinguishable at time $s$ if, for all $\theta_0\in\Theta_0$:
    $$ \exp(-\alpha)\leq \frac{\P_s[B_\delta(\mathcal{A}(s,\theta_0))]}{\P_s'[B_\delta(\mathcal{A}(s,\theta_0))]} \le \exp(\alpha), $$
