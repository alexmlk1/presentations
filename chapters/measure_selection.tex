...
{\color{RoyalBlue}
\begin{remark}
  If, in Definition \ref{def:3}, we measure the set $B_\delta(\theta_0)$ instead, then the notion of $(\alpha,\delta)$-indistinguishability is very close do $\epsilon$-certified unlearning!
  The differences are:
  \begin{itemize}
