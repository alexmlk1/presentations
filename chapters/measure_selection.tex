...
\begin{figure}
  ...
  \caption{Experiments depicting Definition \ref{def:2} when $\Theta_0\subset\R^2$. Blue points represent the initial distribution, green points the LOO retraining and orange points the influence function unlearning.}
  \label{fig:def2exp}
\end{figure}
