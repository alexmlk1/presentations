...
In other words, taken the $\delta$-ball around the end point of the modified algorithm, it may be better to consider the ratio between its $\P_t$ measure and $\tilde{\P}$ measure, where $\tilde{\P}$ is the push-forward measure by the modified algorithm.\\
