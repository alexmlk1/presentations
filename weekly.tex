...
\end{equation*}
\textbf{Question:} Is there a link between $\dot{\theta^j}$ and $J\theta$?
...
\end{figure}
\textbf{Question:} Consider now the map $\theta(t,s):[0,+\infty]\times[0,T]$, with $T\in(0,+\infty]$ fixed a priori, such that:
\begin{equation*}
  \begin{cases}
