...
For example, in \cite{mu_rewind--delete_2025}, the authors take inspiration from the \emph{Descend-to-Delete} algorithm and create a more efficient version called \emph{Rewind-to-Delete}.
